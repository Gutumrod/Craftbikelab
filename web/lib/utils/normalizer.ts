 ...
 * ตาม Logic จาก normalizer.py + Motorcycle Alias Dataset
 */

export const normalizeModelName = (input: string): string => {
  // Step 1: Clean & normalize basic format
  const normalized = input
    .toLowerCase()
    .trim()
    .replace(/\s+/g, ' ') // รวมช่องว่างซ้ำ
    .replace(/[-_]/g, '') // ตัดขีด + underscore
    .replace(/[^\u0E00-\u0E7Fa-z0-9\s]/g, ''); // เอาเฉพาะตัวอักษรไทย, อังกฤษ, ตัวเลข

  // Step 2: Mapping ชื่อเรียกต่างๆ ให้เป็นชื่อมาตรฐาน
  // รองรับ Test Cases ทั้งหมด 50 รุ่น + คำพิมพ์ผิด + คำเรียกแบบคนไทย
  const modelAliases: Record<string, string> = {
    // ========== HONDA ==========
    
    // PCX Series (Test Cases: pcx, pcx160, pcx ตัวเก่า, pcx 150, pcxตัวใหม่)
    'พีซีเอ็กซ์': 'pcx160',
    'pcx': 'pcx160',
    'pcx 150': 'pcx150',
    'pcx150': 'pcx150',
    ...
    // Forza Series (Test Cases: ฟอซ่า, forza, forza350, forza ตัวใหม่, forza300)
    'ฟอร์ซ่า': 'forza350',
    'ฟอซ่า': 'forza350',
    'forza': 'forza350',
    'forza 300': 'forza300',
    ...
    // ADV Series (Test Cases: adv350, adv 350, adv ตัวใหม่, adv160, adv ตัวเล็ก)
    'แอดวี': 'adv350',
    'เอดีวี': 'adv350',
    'adv': 'adv350',
    'adv 150': 'adv150',
    ...
    // CB Series (Test Cases: cb650r, cb 650 r)
    'ซีบี': 'cb650r',
    'cb': 'cb650r',
    'cb 150': 'cb150',
    'cb150': 'cb150',
    ...
    // CBR Series (Test Cases: cbr650r, cbr 650)
    'ซีบีอาร์': 'cbr150',
    'cbr': 'cbr150',
    'cbr 150': 'cbr150',
    'cbr150': 'cbr150',
    ...
    // Rebel Series (Test Cases: rebel300, rebel 300)
    'rebel': 'rebel300',
    'rebel 300': 'rebel300',
    'rebel300': 'rebel300',
    'rebel 500': 'rebel500',
    ...
    // NMAX Series (Test Cases: nmax, nmax155, nแม็ก, nmax ตัวใหม่)
    'เอ็นแม็ก': 'nmax155',
    'เอ็นแม็กซ์': 'nmax155',
    'นแม็ก': 'nmax155',
    'nmax': 'nmax155',
    ...
    // Aerox Series (Test Cases: aerox, aerox155, แอร็อก)
    'แอร์โรคส': 'aerox155',
    'แอร็อก': 'aerox155',
    'เอร็อก': 'aerox155',
    'aerox': 'aerox155',
    ...
    // XSR Series (Test Cases: xsr155, xsr 155, xsr)
    'xsr': 'xsr155',
    'xsr 155': 'xsr155',
    'xsr155': 'xsr155',
    
    // MT Series (Test Cases: mt15, mt 15, mt-15, mt03, mt 03)
    'เอ็มที': 'mt15',
    'mt': 'mt15',
    'mt 15': 'mt15',
    'mt15': 'mt15',
    ...
    // R Series (Test Cases: r15, r15m, r3)
    'อาร์ 15': 'r15',
    'ยามาฮ่า อาร์ 15': 'r15',
    'r': 'r15',
    'r 15': 'r15',
    ...
    // Ninja Series (Test Cases: ninja400, ninja 400, นินจา400)
    'นินจา': 'ninja250',
    'ninja': 'ninja250',
    'ninja 250': 'ninja250',
    'ninja250': 'ninja250',
    ...
    // Z Series (Test Cases: z400, z 400, z900, z 900)
    'ซี': 'z250',
    'z': 'z250',
    'z 250': 'z250',
    'z250': 'z250',
    ...
    // Meteor Series (Test Cases: meteor350, meteor 350)
    'meteor': 'meteor350',
    'meteor 350': 'meteor350',
    'meteor350': 'meteor350',
    
    // Continental GT (Test Cases: continental gt)
  ...
  // Step 4: ถ้าไม่เจอใน aliases ให้คืนค่า normalized
...
export const isKnownModel = (query: string): boolean => {
  ...
  // รายการรุ่นรถที่รู้จัก ทั้งหมด 50+ รุ่น (จริงๆ ควร query จาก Supabase)
  const knownModels = [
    // Honda
...
export const getDisplayName = (normalizedName: string): string => {
  const displayNames: Record<string, string> = {
    // Honda
    'pcx150': 'Honda PCX 150',
    'pcx160': 'Honda PCX 160',
    'forza300': 'Honda Forza 300',
    'forza350': 'Honda Forza 350',
    'adv150': 'Honda ADV 150',
    'adv160': 'Honda ADV 160',
    'adv350': 'Honda ADV 350',
    'click125': 'Honda Click 125',
    'click150': 'Honda Click 150',
    'click160': 'Honda Click 160',
    'wave110': 'Honda Wave 110',
    'wave125': 'Honda Wave 125',
    'cbr150': 'Honda CBR150R',
    'cbr650r': 'Honda CBR650R',
    'cb150': 'Honda CB150R',
    'cb650r': 'Honda CB650R',
    'rebel300': 'Honda Rebel 300',
    'rebel500': 'Honda Rebel 500',
    'msx125': 'Honda MSX 125',
    'grom125': 'Honda Grom 125',
    ...
    'r3': 'Yamaha R3',
    'r6': 'Yamaha R6',
    'xmax300': 'Yamaha XMAX 300',
    'fino125': 'Yamaha Fino 125',
    'mio125': 'Yamaha Mio 125',
    
    // Kawasaki
    'ninja250': 'Kawasaki Ninja 250',
    'ninja400': 'Kawasaki Ninja 400',
    'ninja650': 'Kawasaki Ninja 650',
    'ninja1000': 'Kawasaki Ninja 1000',
    'z250': 'Kawasaki Z250',
    'z400': 'Kawasaki Z400',
    'z650': 'Kawasaki Z650',
    'z900': 'Kawasaki Z900',
    ...
    'versys1000': 'Kawasaki Versys 1000',
    ...
    // Ducati
    'monster821': 'Ducati Monster 821',
    'monster1200': 'Ducati Monster 1200',
    'panigalev2': 'Ducati Panigale V2',
    'panigalev4': 'Ducati Panigale V4',
    'scrambler': 'Ducati Scrambler',
    
    // BMW
    'r1250gs': 'BMW R 1250 GS',
    'r1200gs': 'BMW R 1200 GS',
    's1000rr': 'BMW S 1000 RR',
    'rninet': 'BMW R nineT',
    
    // Suzuki
    'gixxer150': 'Suzuki Gixxer 150',
    'gixxersf': 'Suzuki Gixxer SF',
    'gsxr150': 'Suzuki GSX-R150',
